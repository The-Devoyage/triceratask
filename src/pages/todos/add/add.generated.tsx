...
export type CreateTodoMutation = { __typename?: 'Mutation', create_todo: { __typename?: 'createone_todo_response', data: { __typename?: 'todo', uuid: string, title: string, description: string, completed: boolean, completed_at?: string | null, created_at: string, updated_at: string } } };
