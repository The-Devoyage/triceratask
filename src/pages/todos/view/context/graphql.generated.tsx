 ...
 * });
 */
export function useViewGetTodoQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    ViewGetTodoQuery,
    ViewGetTodoQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<ViewGetTodoQuery, ViewGetTodoQueryVariables>(
    ViewGetTodoDocument,
    options
  );
}
export function useViewGetTodoLazyQuery(
  ...
  return ApolloReactHooks.useLazyQuery<
    ViewGetTodoQuery,
    ViewGetTodoQueryVariables
  >(ViewGetTodoDocument, options);
}
export type ViewGetTodoQueryHookResult = ReturnType<typeof useViewGetTodoQuery>;
export type ViewGetTodoLazyQueryHookResult = ReturnType<
  typeof useViewGetTodoLazyQuery
>;
export type ViewGetTodoQueryResult = Apollo.QueryResult<
  ViewGetTodoQuery,
  ViewGetTodoQueryVariables
>;
