...
export type GetTodosQuery = { __typename?: 'Query', get_todos: Array<{ __typename?: 'todo', id: number, title: string, description: string, completed: boolean, created_at: string, updated_at: string, completed_at?: string | null }> };
